        ...
        <div id="home">
          <div id="circle"></div>
            <div className="left">
              ...
              <p className="default">Não jogue medicamentos no lixo comum! Proteja o meio ambiente e a saúde humana. Junte-se a nós e saiba como fazer o descarte consciente.</p>
